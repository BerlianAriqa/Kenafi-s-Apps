...
import 'package:kenafi/pages/help_page.dart'; // Mengimpor halaman Bantuan
import 'package:kenafi/pages/home_page.dart'; // Mengimpor halaman Utama

void main() {
  runApp(const MyApp()); // Menjalankan aplikasi dengan MyApp sebagai root widget
}

// Mendefinisikan MyApp sebagai StatelessWidget
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MainPage(), // Mengatur MainPage sebagai halaman utama
    );
  }
}
...
// Mendefinisikan LoginPage sebagai StatelessWidget

...
class KenafiFonts extends KenafiColors {
  ...
  TextStyle boldQuicksand({
    ...
    return TextStyle(
      ...
      color: color ?? KenafiColors.black,
  ...
  KenafiFonts(this.context) {
    textButton = const TextStyle(
      color: KenafiColors.primary,
      fontFamily: 'PMedium',
      fontSize: 16,
    );
